...
type RouteParams = {  };
type RouteId = '/(admin)/admin/graph';
...
type ActionsExport = typeof import('../../../../../../../src/routes/(admin)/admin/graph/+page.server.js').actions
export type SubmitFunction = Kit.SubmitFunction<Expand<ActionsSuccess<ActionsExport>>, Expand<ActionsFailure<ActionsExport>>>
export type ActionData = Expand<Kit.AwaitedActions<ActionsExport>> | null;
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/(admin)/admin/graph/+page.server.js').load>>>>>>;
