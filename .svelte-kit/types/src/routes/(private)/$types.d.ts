...
type LayoutRouteId = RouteId | "/(private)" | "/(private)/graph" | "/(private)/logout" | "/(private)/rummy"
...
export type LayoutServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../src/routes/(private)/+layout.server.js').load>>>>>>;
